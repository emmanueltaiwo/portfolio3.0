...
const Footer = () => {
  return (
    <footer className="pt-[20vh] pb-[10vh] h-full flex flex-col gap-5 w-full relative">
      <Image
      ...
      <div className="flex flex-wrap flex-col md:flex-row md:justify-between lg:justify-around lg:gap-5 lg:pb-10">
        <div className="flex flex-col p-5 lg:p-0 gap-5 lg:relative">
        ...
        <div className="z-10 p-5 lg:grid lg:grid-cols-2 lg:gap-10 flex gap-5 flex-wrap items-center">
          <a
      ...
      <div className="lg:w-[85%] w-full p-5 lg:p-0 flex flex-wrap flex-col md:flex-row justify-between mx-auto lg:gap-5 md:items-center items-start">
        <Link
          href="/"
